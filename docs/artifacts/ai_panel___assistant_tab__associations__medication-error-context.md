...
- generic [ref=e2]:
  ...
  - generic [ref=e17]:
    ...
    - generic [ref=e47]:
      - generic [ref=e48]:
        - button "Clinical Assistant" [ref=e51]
        - generic [ref=e55]:
          - button "In Progress" [ref=e56] [cursor=pointer]: In Progress
          - button "Completed" [active] [ref=e57] [cursor=pointer]: Completed
          - button "All" [ref=e58] [cursor=pointer]: All
      - contentinfo [ref=e188]:
        - paragraph [ref=e190]: asksam does not provide medical advice, diagnosis, or treatment recommendations. Output must be reviewed by a qualified clinician. asksam is not designed to replace clinical reasoning or provide medical decision guidance.
```