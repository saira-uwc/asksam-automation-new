...
//   await page.waitForTimeout(10000);
//   await page.getByRole('button', { name: 'I Understand and Accept the' }).click();
//   await page.waitForTimeout(10000);
//   await page.locator('div').filter({ hasText: 'CautionPlease review the' }).nth(1).click();
//   await page.waitForTimeout(10000);
//   await page.getByRole('button', { name: 'I Understand and Accept the' }).click();
//   await page.waitForTimeout(10000);
